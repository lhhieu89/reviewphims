...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const videoCategoryId = CATEGORY_MAPPING[type as keyof typeof CATEGORY_MAPPING] || '24';
    ...
    let errorMessage = 'Failed to fetch popular videos';
    let fallbackUrl = 'https://www.youtube.com/feed/trending';
